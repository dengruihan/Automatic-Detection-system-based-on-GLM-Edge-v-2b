...
os.environ["CUDA_VISIBLE_DEVICES"] = "0" # 新增：强制仅使用第一张显卡
...
def main(
    ...
    # 强制单卡训练配置
    ft_config.training_args.ddp_find_unused_parameters = False
    ft_config.training_args.local_rank = -1  # 禁用分布式训练
    ft_config.training_args._n_gpu = 1       # 显式设置GPU数量为1
